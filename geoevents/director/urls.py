...
urlpatterns = patterns('',
	...
	url(r'^board/(?P<pk>\d+)/$', 'geoevents.director.views.DirectorDashboardView', name='director-dashboard-view'),
    url(r'^board/(?P<pk>\d+)/(?P<slug>[\w\d\-]+)/$', 'geoevents.director.views.DirectorDashboardView', name='director-dashboard-view-slug'),
	url(r'^board/(?P<org>\w+)/$', 'geoevents.director.views.DirectorDashboardViewOrg', name='director-dashboard-view-org'),

    url(r'^rate/(?P<model>\w+)/(?P<pk>\d+)/$', 'geoevents.director.views.SocialRate', name='social-rate'),

    url(r'^quadchart/(?P<pk>\d+)/$', 'geoevents.director.views.QuadChartView', name='prog-obs-quad-chart'),
    ...
    url(r'^report/link/(?P<pk_report>\d+)/(?P<model>\w+)/(?P<pk_target>\d+)/$', 'geoevents.director.views.ReportLink', name='reports-linkage'),
    ...
    url(r'^report/manage/(?P<pk>\d+)/$', permission_required('director.change_report', reverse_lazy('home'))(
                             UpdateView.as_view(queryset=Report.objects.all(),
                             form_class=ReportForm,
                             template_name='report-manage.html',
                             )), name='reports-manage-report-id'),
    url(r'^report/delete/(?P<pk>\d+)/$', permission_required('director.delete_report', reverse_lazy('home'))(
    ...
    url(r'^action/manage/(?P<pk>\d+)/$', permission_required('director.change_actions', reverse_lazy('home'))(
                             UpdateView.as_view(queryset=Actions.objects.all(),
                             form_class=ActionForm,
                             template_name='report-manage.html',
                             )), name='actions-manage-report-id'),
    url(r'^action/delete/(?P<pk>\d+)/$', permission_required('director.delete_actions', reverse_lazy('home'))(
                             DeleteView.as_view(model=Report,
                             template_name='generic-delete.html',
                             success_url= reverse_lazy('actions-view-reports'))
...
##    url(r'^billet/new/$', 'geoevents.director.views.BilletNew', name='billets-submit-new'),
    ...
    url(r'^billet/manage/(?P<pk>\d+)/$', permission_required('director.change_billet', reverse_lazy('home'))(
                             UpdateView.as_view(queryset=Billet.objects.all(),
                             form_class=BilletForm,
                             template_name='report-manage.html',
                             )), name='billets-manage-report-id'),
    url(r'^billet/delete/(?P<pk>\d+)/$', permission_required('director.delete_billet', reverse_lazy('home'))(
                             DeleteView.as_view(model=Report,
                             template_name='generic-delete.html',
                             success_url= reverse_lazy('billets-view-reports'))
