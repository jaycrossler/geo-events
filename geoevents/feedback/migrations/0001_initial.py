...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feedback_feedback', (
            ...
            ('subject', self.gf('django.db.models.fields.CharField')(default='R3 Landing Page', max_length=25)),
    ...
    models = {
        'feedback.feedback': {
            ...
            'subject': ('django.db.models.fields.CharField', [], {'default': "'R3 Landing Page'", 'max_length': '25'}),
